...
MAZELENGTH	= 101                # the length of the maze                                                               */
MAZEWIDTH 	= 101                # the width of the maze
MAZEHEIGHT	= 61                                                            
...
GOALX = random.randint(80,100)   # x coordinate of the goal  cell                                                      */
GOALY = random.randint(80,100)   # y coordinate of the goal  cell 
GOALZ = random.randint(50,60)
