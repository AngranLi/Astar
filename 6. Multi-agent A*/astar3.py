...
startPoint  = (0, 0, 0)
endPoint    = (0, 0, 0)
current_position  = (2.0, 4.0, 1.0)
target_position   = (2.0, 1.0, 1.5)

''' Initialize ROS node and publishers '''
rospy.init_node('astar_node', anonymous=True) # rosnode name
(pathPub, pointsPub, boundPub, obstPub, roughPub, refinedPub) = init.initPublishers(3) # initialize publishers
...
while callback_current_flg:
    ppSub   = rospy.Subscriber('/UAV_3/pose', PoseStamped, callback_current)
