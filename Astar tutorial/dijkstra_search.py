...
diagram1 = GridWithWeights(30, 15)
diagram1.walls = DIAGRAM1_WALLS

came_from, cost_so_far = dijkstra_search(diagram1, (8, 7), (17, 2))
draw_grid(diagram1, width=2, point_to=came_from, start=(8, 7), goal=(17, 2))
print()
draw_grid(diagram1, width=2, number=cost_so_far, start=(8, 7), goal=(17, 2))
print()
draw_grid(diagram1, width=2, path=reconstruct_path(came_from, start=(8, 7), goal=(17, 2)))
